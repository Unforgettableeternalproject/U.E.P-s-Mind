...
exports.run = (client, message, args) =>{
    ...
    .setColor("#c5ad09")
    .setDescription("This is a server made by Bernie, and I am U.E.P, an embodiment of the primal force [Polymerization]. In this server, you can basically do what ever you want, just follow the rules, or I will punish you (ノ｀Д)ノ. Below are some special word you might have heard, but never know what it's for.")
    .addField("The Counsel of the World", "Gods, a.k.a bots, though I am also a bot, but i am built different. （︶^︶）")
    .addField("The Governer", "The head admins of this server, Bernie is one of them.")
